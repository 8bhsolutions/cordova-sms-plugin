...
public class Sms extends CordovaPlugin {
    ...
    private static final int REQUEST_PERMISSION_READ_PHONE_STATE_REQ_CODE = 2;
    ...
    public void onRequestPermissionResult(int requestCode, String[] permissions, int[] grantResults) throws JSONException {
        ...
        if (requestCode == REQUEST_PERMISSION_READ_PHONE_STATE_REQ_CODE) {
            // If user granted permission, try sending it again
            sendSMS();
            return;
        }
